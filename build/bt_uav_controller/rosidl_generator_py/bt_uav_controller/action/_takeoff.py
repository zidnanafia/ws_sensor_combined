...
class Metaclass_Takeoff_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('bt_uav_controller')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'bt_uav_controller.action.Takeoff_Goal')
            logger.debug(
...
class Metaclass_Takeoff_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'bt_uav_controller.action.Takeoff_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Takeoff_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'bt_uav_controller.action.Takeoff_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Takeoff_Feedback(metaclass=Metaclass_Takeoff_Feedback):
    ...
    def current_altitude(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'current_altitude' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
...
class Metaclass_Takeoff_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from bt_uav_controller.action import Takeoff
...
class Takeoff_SendGoal_Request(metaclass=Metaclass_Takeoff_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'bt_uav_controller/Takeoff_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['bt_uav_controller', 'action'], 'Takeoff_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from bt_uav_controller.action._takeoff import Takeoff_Goal
...
class Metaclass_Takeoff_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'bt_uav_controller.action.Takeoff_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from bt_uav_controller.action import _takeoff
...
class Takeoff_SendGoal(metaclass=Metaclass_Takeoff_SendGoal):
    from bt_uav_controller.action._takeoff import Takeoff_SendGoal_Request as Request
    from bt_uav_controller.action._takeoff import Takeoff_SendGoal_Response as Response
...
class Takeoff_GetResult_Response(metaclass=Metaclass_Takeoff_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'bt_uav_controller/Takeoff_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['bt_uav_controller', 'action'], 'Takeoff_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from bt_uav_controller.action._takeoff import Takeoff_Result
...
class Metaclass_Takeoff_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'bt_uav_controller.action.Takeoff_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Takeoff_GetResult(metaclass=Metaclass_Takeoff_GetResult):
    from bt_uav_controller.action._takeoff import Takeoff_GetResult_Request as Request
    from bt_uav_controller.action._takeoff import Takeoff_GetResult_Response as Response
...
class Metaclass_Takeoff_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'bt_uav_controller.action.Takeoff_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Takeoff_FeedbackMessage(metaclass=Metaclass_Takeoff_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'bt_uav_controller/Takeoff_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['bt_uav_controller', 'action'], 'Takeoff_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from bt_uav_controller.action._takeoff import Takeoff_Feedback
...
class Metaclass_Takeoff(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'bt_uav_controller.action.Takeoff')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Takeoff(metaclass=Metaclass_Takeoff):
    ...
    from bt_uav_controller.action._takeoff import Takeoff_Goal as Goal
    # The result message defined in the action definition.
    from bt_uav_controller.action._takeoff import Takeoff_Result as Result
    # The feedback message defined in the action definition.
    from bt_uav_controller.action._takeoff import Takeoff_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from bt_uav_controller.action._takeoff import Takeoff_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from bt_uav_controller.action._takeoff import Takeoff_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from bt_uav_controller.action._takeoff import Takeoff_FeedbackMessage as FeedbackMessage
