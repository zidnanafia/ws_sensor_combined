...
enum
{
  px4_msgs__msg__EstimatorStatus__CS_GNSS_POS = 2
};
...
enum
{
  px4_msgs__msg__EstimatorStatus__CS_GNSS_VEL = 44
};

/// Constant 'CS_GNSS_FAULT'.
/**
  * 45 - true if GNSS measurements have been declared faulty and are no longer used
 */
enum
{
  px4_msgs__msg__EstimatorStatus__CS_GNSS_FAULT = 45
};

/// Constant 'CS_YAW_MANUAL'.
/**
  * 46 - true if yaw has been set manually
 */
enum
{
  px4_msgs__msg__EstimatorStatus__CS_YAW_MANUAL = 46
};
