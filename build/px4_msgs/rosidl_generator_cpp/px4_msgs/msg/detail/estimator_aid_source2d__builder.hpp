...
class Init_EstimatorAidSource2d_test_ratio_filtered
{
public:
  explicit Init_EstimatorAidSource2d_test_ratio_filtered(::px4_msgs::msg::EstimatorAidSource2d & msg)
  : msg_(msg)
  {}
  Init_EstimatorAidSource2d_innovation_rejected test_ratio_filtered(::px4_msgs::msg::EstimatorAidSource2d::_test_ratio_filtered_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_EstimatorAidSource2d_test_ratio_filtered test_ratio(::px4_msgs::msg::EstimatorAidSource2d::_test_ratio_type arg)
  {
    msg_.test_ratio = std::move(arg);
    return Init_EstimatorAidSource2d_test_ratio_filtered(msg_);
  }
...
class Init_EstimatorAidSource2d_innovation_filtered
{
public:
  explicit Init_EstimatorAidSource2d_innovation_filtered(::px4_msgs::msg::EstimatorAidSource2d & msg)
  : msg_(msg)
  {}
  Init_EstimatorAidSource2d_innovation_variance innovation_filtered(::px4_msgs::msg::EstimatorAidSource2d::_innovation_filtered_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_EstimatorAidSource2d_innovation_filtered innovation(::px4_msgs::msg::EstimatorAidSource2d::_innovation_type arg)
  {
    msg_.innovation = std::move(arg);
    return Init_EstimatorAidSource2d_innovation_filtered(msg_);
  }
