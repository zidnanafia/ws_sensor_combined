...
#ifndef _WIN32
# define DEPRECATED__px4_msgs__msg__EstimatorAidSource3d __attribute__((deprecated))
#else
# define DEPRECATED__px4_msgs__msg__EstimatorAidSource3d __declspec(deprecated)
#endif
...
struct EstimatorAidSource3d_
{
  using Type = EstimatorAidSource3d_<ContainerAllocator>;

  explicit EstimatorAidSource3d_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit EstimatorAidSource3d_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : observation(_alloc),
  ...
  // pointer types
  using RawPtr =
    px4_msgs::msg::EstimatorAidSource3d_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4_msgs::msg::EstimatorAidSource3d_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4_msgs::msg::EstimatorAidSource3d_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4_msgs::msg::EstimatorAidSource3d_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4_msgs::msg::EstimatorAidSource3d_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::EstimatorAidSource3d_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::EstimatorAidSource3d_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4_msgs::msg::EstimatorAidSource3d_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4_msgs::msg::EstimatorAidSource3d_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4_msgs__msg__EstimatorAidSource3d
    std::shared_ptr<px4_msgs::msg::EstimatorAidSource3d_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4_msgs__msg__EstimatorAidSource3d
    std::shared_ptr<px4_msgs::msg::EstimatorAidSource3d_<ContainerAllocator> const>
  ...
  bool operator==(const EstimatorAidSource3d_ & other) const
  {
...
using EstimatorAidSource3d =
  px4_msgs::msg::EstimatorAidSource3d_<std::allocator<void>>;
...
#endif  // PX4_MSGS__MSG__DETAIL__ESTIMATOR_AID_SOURCE3D__STRUCT_HPP_
