  ...
  std::ostream & out)
{
  ...
  {
    out << "hdg_test_ratio: ";
    rosidl_generator_traits::value_to_yaml(msg.hdg_test_ratio, out);
    out << ", ";
  }
  ...
  {
    out << "pre_flt_fail_innov_pos_horiz: ";
    rosidl_generator_traits::value_to_yaml(msg.pre_flt_fail_innov_pos_horiz, out);
    out << ", ";
  }
