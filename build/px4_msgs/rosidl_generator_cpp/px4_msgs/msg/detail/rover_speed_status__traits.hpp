...
#ifndef PX4_MSGS__MSG__DETAIL__ROVER_SPEED_STATUS__TRAITS_HPP_
#define PX4_MSGS__MSG__DETAIL__ROVER_SPEED_STATUS__TRAITS_HPP_
...
inline void to_yaml(
  const px4_msgs::msg::RoverSpeedStatus & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4_msgs::msg::RoverSpeedStatus & msg)
{
  return px4_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<px4_msgs::msg::RoverSpeedStatus>()
{
  return "px4_msgs::msg::RoverSpeedStatus";
}

template<>
inline const char * name<px4_msgs::msg::RoverSpeedStatus>()
{
  return "px4_msgs/msg/RoverSpeedStatus";
}

template<>
struct has_fixed_size<px4_msgs::msg::RoverSpeedStatus>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<px4_msgs::msg::RoverSpeedStatus>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<px4_msgs::msg::RoverSpeedStatus>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // PX4_MSGS__MSG__DETAIL__ROVER_SPEED_STATUS__TRAITS_HPP_
