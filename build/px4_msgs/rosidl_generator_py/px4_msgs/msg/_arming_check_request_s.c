...
bool px4_msgs__msg__arming_check_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._arming_check_request.ArmingCheckRequest", full_classname_dest, 53) == 0);
  }
  px4_msgs__msg__ArmingCheckRequest * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__arming_check_request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of ArmingCheckRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._arming_check_request");
  ...
  px4_msgs__msg__ArmingCheckRequest * ros_message = (px4_msgs__msg__ArmingCheckRequest *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
