...
bool px4_msgs__msg__fixed_wing_lateral_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._fixed_wing_lateral_status.FixedWingLateralStatus", full_classname_dest, 62) == 0);
  }
  px4_msgs__msg__FixedWingLateralStatus * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__fixed_wing_lateral_status__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of FixedWingLateralStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._fixed_wing_lateral_status");
  ...
  px4_msgs__msg__FixedWingLateralStatus * ros_message = (px4_msgs__msg__FixedWingLateralStatus *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
