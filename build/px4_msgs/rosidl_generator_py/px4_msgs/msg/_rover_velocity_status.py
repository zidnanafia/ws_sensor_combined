...
class RoverVelocityStatus(metaclass=Metaclass_RoverVelocityStatus):
    ...
    def speed_body_x_setpoint(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'speed_body_x_setpoint' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def speed_body_y_setpoint(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'speed_body_y_setpoint' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
