...
bool px4_msgs__msg__trajectory_setpoint6dof__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._trajectory_setpoint6dof.TrajectorySetpoint6dof", full_classname_dest, 60) == 0);
  }
  px4_msgs__msg__TrajectorySetpoint6dof * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__trajectory_setpoint6dof__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of TrajectorySetpoint6dof */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._trajectory_setpoint6dof");
  ...
  px4_msgs__msg__TrajectorySetpoint6dof * ros_message = (px4_msgs__msg__TrajectorySetpoint6dof *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
