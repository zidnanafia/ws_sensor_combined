...
class Metaclass_TrajectoryWaypoint(type):
    """Metaclass of message 'TrajectoryWaypoint'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__trajectory_waypoint
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__trajectory_waypoint
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__trajectory_waypoint
            cls._TYPE_SUPPORT = module.type_support_msg__msg__trajectory_waypoint
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__trajectory_waypoint
...
class TrajectoryWaypoint(metaclass=Metaclass_TrajectoryWaypoint):
    """Message class 'TrajectoryWaypoint'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.point_valid = kwargs.get('point_valid', bool())
    ...
    def __eq__(self, other):
        ...
        if self.yaw_speed != other.yaw_speed:
            return False
        if self.point_valid != other.point_valid:
            return False
    ...
    def point_valid(self, value):
        if __debug__:
            assert \
                ...
                "The 'point_valid' field must be of type 'bool'"
