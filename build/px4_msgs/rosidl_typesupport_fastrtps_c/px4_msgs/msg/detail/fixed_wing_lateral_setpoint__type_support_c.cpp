...
#include "px4_msgs/msg/detail/fixed_wing_lateral_setpoint__rosidl_typesupport_fastrtps_c.h"
...
using _FixedWingLateralSetpoint__ros_msg_type = px4_msgs__msg__FixedWingLateralSetpoint;
...
static uint32_t _FixedWingLateralSetpoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4_msgs__msg__FixedWingLateralSetpoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_msgs__msg__FixedWingLateralSetpoint;
    is_plain =
      (
...
static size_t _FixedWingLateralSetpoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4_msgs__msg__FixedWingLateralSetpoint(
