...
#include "px4_msgs/msg/detail/rover_attitude_setpoint__rosidl_typesupport_fastrtps_c.h"
...
using _RoverAttitudeSetpoint__ros_msg_type = px4_msgs__msg__RoverAttitudeSetpoint;
...
size_t get_serialized_size_px4_msgs__msg__RoverAttitudeSetpoint(
  const void * untyped_ros_message,
...
static uint32_t _RoverAttitudeSetpoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4_msgs__msg__RoverAttitudeSetpoint(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
size_t max_serialized_size_px4_msgs__msg__RoverAttitudeSetpoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_msgs__msg__RoverAttitudeSetpoint;
    is_plain =
      (
...
static size_t _RoverAttitudeSetpoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4_msgs__msg__RoverAttitudeSetpoint(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, msg, RoverAttitudeSetpoint)() {
