...
#include "px4_msgs/msg/detail/debug_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_msgs::msg::DebugArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs::msg::DebugArray & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_msgs::msg::DebugArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::DebugArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::msg::DebugArray *>(
    untyped_ros_message);
...
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_DebugArray__handle;
}
