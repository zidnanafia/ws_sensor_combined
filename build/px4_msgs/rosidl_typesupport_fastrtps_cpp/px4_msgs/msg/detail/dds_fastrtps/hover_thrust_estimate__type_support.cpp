...
#include "px4_msgs/msg/detail/hover_thrust_estimate__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_msgs::msg::HoverThrustEstimate & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs::msg::HoverThrustEstimate & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_msgs::msg::HoverThrustEstimate;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::HoverThrustEstimate *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::msg::HoverThrustEstimate *>(
    untyped_ros_message);
...
get_message_type_support_handle<px4_msgs::msg::HoverThrustEstimate>()
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_HoverThrustEstimate__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, HoverThrustEstimate)() {
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_HoverThrustEstimate__handle;
}
