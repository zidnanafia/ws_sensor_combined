...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs::msg::LaunchDetectionStatus & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::LaunchDetectionStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::msg::LaunchDetectionStatus *>(
    untyped_ros_message);
...
get_message_type_support_handle<px4_msgs::msg::LaunchDetectionStatus>()
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_LaunchDetectionStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, LaunchDetectionStatus)() {
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_LaunchDetectionStatus__handle;
}
