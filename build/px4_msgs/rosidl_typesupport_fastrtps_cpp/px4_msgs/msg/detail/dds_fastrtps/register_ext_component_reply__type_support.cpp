...
#include "px4_msgs/msg/detail/register_ext_component_reply__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_msgs::msg::RegisterExtComponentReply & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs::msg::RegisterExtComponentReply & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_msgs::msg::RegisterExtComponentReply;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::RegisterExtComponentReply *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::msg::RegisterExtComponentReply *>(
    untyped_ros_message);
...
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_RegisterExtComponentReply__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, RegisterExtComponentReply)() {
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_RegisterExtComponentReply__handle;
}
