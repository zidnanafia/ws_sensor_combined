  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_msgs::msg::RoverVelocityStatus;
    is_plain =
      (
...
static size_t _RoverVelocityStatus__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_RoverVelocityStatus(full_bounded, is_plain, 0);
