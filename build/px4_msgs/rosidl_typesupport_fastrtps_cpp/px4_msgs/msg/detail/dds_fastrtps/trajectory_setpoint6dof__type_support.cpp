...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::TrajectorySetpoint6dof *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::msg::TrajectorySetpoint6dof *>(
    untyped_ros_message);
...
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_TrajectorySetpoint6dof__handle;
}
