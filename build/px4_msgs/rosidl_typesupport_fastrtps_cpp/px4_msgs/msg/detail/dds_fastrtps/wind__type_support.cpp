...
#include "px4_msgs/msg/detail/wind__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_msgs::msg::Wind & ros_message,
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_msgs::msg::Wind;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::Wind *>(
    untyped_ros_message);
...
get_message_type_support_handle<px4_msgs::msg::Wind>()
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_Wind__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, Wind)() {
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_Wind__handle;
}
