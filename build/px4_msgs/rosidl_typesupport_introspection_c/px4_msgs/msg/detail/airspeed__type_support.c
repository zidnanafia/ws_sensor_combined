...
#include <stddef.h>
#include "px4_msgs/msg/detail/airspeed__rosidl_typesupport_introspection_c.h"
...
void px4_msgs__msg__Airspeed__rosidl_typesupport_introspection_c__Airspeed_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  px4_msgs__msg__Airspeed__init(message_memory);
}

void px4_msgs__msg__Airspeed__rosidl_typesupport_introspection_c__Airspeed_fini_function(void * message_memory)
{
...
static rosidl_typesupport_introspection_c__MessageMember px4_msgs__msg__Airspeed__rosidl_typesupport_introspection_c__Airspeed_message_member_array[5] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__Airspeed, timestamp_sample),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static rosidl_message_type_support_t px4_msgs__msg__Airspeed__rosidl_typesupport_introspection_c__Airspeed_message_type_support_handle = {
  0,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4_msgs, msg, Airspeed)() {
  if (!px4_msgs__msg__Airspeed__rosidl_typesupport_introspection_c__Airspeed_message_type_support_handle.typesupport_identifier) {
    px4_msgs__msg__Airspeed__rosidl_typesupport_introspection_c__Airspeed_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &px4_msgs__msg__Airspeed__rosidl_typesupport_introspection_c__Airspeed_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
