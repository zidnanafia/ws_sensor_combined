...
void px4_msgs__msg__Ekf2Timestamps__rosidl_typesupport_introspection_c__Ekf2Timestamps_init_function(
...
void px4_msgs__msg__Ekf2Timestamps__rosidl_typesupport_introspection_c__Ekf2Timestamps_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers px4_msgs__msg__Ekf2Timestamps__rosidl_typesupport_introspection_c__Ekf2Timestamps_message_members = {
  ...
  px4_msgs__msg__Ekf2Timestamps__rosidl_typesupport_introspection_c__Ekf2Timestamps_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t px4_msgs__msg__Ekf2Timestamps__rosidl_typesupport_introspection_c__Ekf2Timestamps_message_type_support_handle = {
  0,
  &px4_msgs__msg__Ekf2Timestamps__rosidl_typesupport_introspection_c__Ekf2Timestamps_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4_msgs, msg, Ekf2Timestamps)() {
  if (!px4_msgs__msg__Ekf2Timestamps__rosidl_typesupport_introspection_c__Ekf2Timestamps_message_type_support_handle.typesupport_identifier) {
    px4_msgs__msg__Ekf2Timestamps__rosidl_typesupport_introspection_c__Ekf2Timestamps_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &px4_msgs__msg__Ekf2Timestamps__rosidl_typesupport_introspection_c__Ekf2Timestamps_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
