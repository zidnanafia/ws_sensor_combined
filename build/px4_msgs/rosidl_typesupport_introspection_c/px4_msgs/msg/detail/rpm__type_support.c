...
void px4_msgs__msg__Rpm__rosidl_typesupport_introspection_c__Rpm_init_function(
...
void px4_msgs__msg__Rpm__rosidl_typesupport_introspection_c__Rpm_fini_function(void * message_memory)
{
  px4_msgs__msg__Rpm__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember px4_msgs__msg__Rpm__rosidl_typesupport_introspection_c__Rpm_message_member_array[3] = {
  {
    "timestamp",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers px4_msgs__msg__Rpm__rosidl_typesupport_introspection_c__Rpm_message_members = {
...
static rosidl_message_type_support_t px4_msgs__msg__Rpm__rosidl_typesupport_introspection_c__Rpm_message_type_support_handle = {
  0,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4_msgs, msg, Rpm)() {
  if (!px4_msgs__msg__Rpm__rosidl_typesupport_introspection_c__Rpm_message_type_support_handle.typesupport_identifier) {
    px4_msgs__msg__Rpm__rosidl_typesupport_introspection_c__Rpm_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &px4_msgs__msg__Rpm__rosidl_typesupport_introspection_c__Rpm_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
