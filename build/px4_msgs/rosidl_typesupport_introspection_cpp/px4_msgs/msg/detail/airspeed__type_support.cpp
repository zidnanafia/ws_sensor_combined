...
{
  new (message_memory) px4_msgs::msg::Airspeed(_init);
}

void Airspeed_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4_msgs::msg::Airspeed *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Airspeed_message_member_array[5] = {
  {
    ...
    offsetof(px4_msgs::msg::Airspeed, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::Airspeed, timestamp_sample),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::Airspeed, indicated_airspeed_m_s),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::Airspeed, true_airspeed_m_s),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::Airspeed, confidence),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<px4_msgs::msg::Airspeed>()
{
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::Airspeed_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4_msgs, msg, Airspeed)() {
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::Airspeed_message_type_support_handle;
}
