...
{
  new (message_memory) px4_msgs::msg::RoverRateSetpoint(_init);
}

void RoverRateSetpoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4_msgs::msg::RoverRateSetpoint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RoverRateSetpoint_message_member_array[2] = {
  {
    ...
    offsetof(px4_msgs::msg::RoverRateSetpoint, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::RoverRateSetpoint, yaw_rate_setpoint),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RoverRateSetpoint_message_members = {
  ...
  2,  // number of fields
  sizeof(px4_msgs::msg::RoverRateSetpoint),
...
get_message_type_support_handle<px4_msgs::msg::RoverRateSetpoint>()
{
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::RoverRateSetpoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4_msgs, msg, RoverRateSetpoint)() {
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::RoverRateSetpoint_message_type_support_handle;
}
